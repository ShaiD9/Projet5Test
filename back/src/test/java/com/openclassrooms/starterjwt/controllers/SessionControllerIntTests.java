...
public class SessionControllerIntTests {
    ...
    public static void setUp() {
        ...
        session.setDescription("Testing description");
        ...
        sessionDto.setDescription("Testing description");
    ...
    class update {
        ...
        public void shouldUpdatedSessionWhenSessionIsUpdated() throws Exception {
            ...
            updatedSessionDto.setDescription("Testing description Updated");
            ...
            mockMvc.perform(MockMvcRequestBuilders.put("/api/session/1")
                    ...
                    .andExpect(jsonPath("$.teacher_id").value(1L))
                    .andExpect(jsonPath("$.users").isEmpty())
                    .andExpect(jsonPath("$.description").value("Testing description Updated"));
